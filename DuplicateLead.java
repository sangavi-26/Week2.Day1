	...
	/ Launches new browser for every execution
		public static void main(String[] args) {
	     ...
	     //To get resultant page title
			...
			//Clear Company Name and Inputting another company name
			WebElement clearfield = driver.findElement(By.id("createLeadForm_companyName"));
			clearfield.clear();
			clearfield.sendKeys("DMI");
			
			//Clear First Name and Inputting some other name
			WebElement namefield = driver.findElement(By.id("createLeadForm_firstName"));
			namefield.clear();
			namefield.sendKeys("Ramji");
			
			//Click Submit button
			driver.findElement(By.className("smallSubmit")).click();
			
			//To get the resultant page title 
